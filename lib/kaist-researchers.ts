...
export const kaistResearchers: KaistResearcher[] = [
  ...
  { id:"kaist-acoustic-microfluidics", lab:"헬스케어 음향미세유체 연구실", professor:"성형진 교수", department:"기계공학", keywords:["음향","마이크로유체","의료기기","기계공학","바이오메디컬"] },
  { id:"kaist-computational-materials", lab:"응집물질계산물리 연구실", professor:"장기주 교수", department:"물리학", keywords:["계산재료","응집물질","물리학","시뮬레이션","재료과학","양자"] },
  { id:"kaist-catalyst-design", lab:"촉매설계 및 화학반응 연구실", professor:"유룡 교수", department:"화학", keywords:["촉매","화학반응","분자설계","합성","화학"] },
  ...
  { id:"kaist-semiconductor-packaging", lab:"KAIST 시스템 반도체 패키징 연구실", professor:"김정호 교수", department:"전기공학", keywords:["시스템반도체","패키징","반도체","회로","전기전자"] },
  ...
  { id:"kaist-vic-agi", lab:"비전중심 범용 인공지능 연구실(ViC-AGI)", professor:"권인소 교수", department:"전기공학", keywords:["인공지능","컴퓨터비전","AGI","딥러닝","전기전자"] },
  { id:"kaist-ai-semiconductor", lab:"차세대 AI 반도체 시스템 연구실", professor:"유회준 교수", department:"전기공학", keywords:["AI반도체","인공지능","시스템반도체","가속기","전기전자"] },
