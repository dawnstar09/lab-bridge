...
const copy: Record<Locale, Record<string,string>> = {
  ko:{intro:"등록한 연구계획과 연구자 프로필을 바탕으로 협업 대상을 찾습니다.",saved:"프로젝트가 등록되었습니다.",requested:"미팅 요청을 저장했습니다.",close:"닫기",funding:"크라우드 펀딩",fundingIntro:"연구계획을 공개하고 초기 협력과 자원을 확보합니다.",register:"프로젝트 등록",registered:"등록됨",goal:"목표 금액",created:"등록일",empty:"등록한 프로젝트가 없습니다.",matching:"KAIST 연구실 매칭",matchingIntro:"전공·관심 연구·논문 키워드와 연구실 설명의 코사인 유사도로 정렬합니다.",source:"KAIST 연구실 데이터",fit:"텍스트 적합도",meeting:"미팅 요청",meetingDone:"요청 저장됨",reason:"일치 키워드",low:"프로필의 관심 연구와 논문을 더 입력하면 매칭이 정교해집니다.",newProject:"펀딩 프로젝트 등록",name:"프로젝트명",amount:"목표 금액",description:"프로젝트 설명",submit:"등록하기"},
